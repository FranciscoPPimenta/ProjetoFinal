        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                    <!-- Page Heading -->
                    <h1 class="h3 fs-1 text-gray-800 fw-bold">Cursos</h1>
                    <?php
                    if (isset($_SESSION["deleted"])) {
                        echo '<p class="fs-3 text-danger">Curso ' . $_SESSION["deletedObject"] . ' apagado com sucesso!</p>';
                    }
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h1 class="m-0 font-weight-bold text-primary">Tabela Cursos</h1>
                            <a class="btn btn-primary" href="create.php">Criar Novo Curso</a>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="../../database/cursos/editar_curso.php?id=<?php echo $curso["id_curso"] ?>">Editar</a>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal"
                                                        onclick="setDeleteModalText('<?php echo $curso['nome']; ?>','<?php echo $curso['id_curso'] ?>')">Apagar</button>
                                                </td>
                                            </tr>
                                        <?php
                                        }
