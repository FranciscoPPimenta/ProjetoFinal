...
<body id="page-top">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body" id="notEditing">
                                        <p style="font-size:80px" class="card-title">
                                            <?php echo $_SESSION["animacao"]["nome"]; ?></p>
                                    </div>
                                    <div class="card-body" id="Editing" hidden>
                                        <form
                                            action='../../database/animacoes/edit.php?id=<?php echo $_SESSION['animacao']['id_animacao']; ?>'
                                            method="POST" enctype="multipart/form-data">
                                            <p style="font-size:15px">Nome:</p>
                                            <input type="text" style="margin:5px;font-size:20px" class="form-control"
                                                name="nome" id="nome" value="<?php echo $_SESSION["animacao"]["nome"]; ?>"
                                                required>
                                            <p style="font-size:15px">Nova Textura:</p>
                                            <input type="file" style="margin:5px;font-size:20px" class="form-control"
                                                name="textura" id="textura">
                                            <p style="font-size:15px">Nova Objeto:</p>
                                            <input type="file" style="margin:5px;font-size:20px" class="form-control"
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="deleteModalLabel">Apagar Animacao</h1>
                ...
                <div class="modal-footer">
                    ...
                    <a id="apagaAnimacao" type="button" class="btn btn-primary">Sim</a>
                </div>
            </div>
        </div>
    </div>
    ...
    ?>
        <script>
            ...
            function setUpdateModalText() {
                var string = "De certeza que quer atualizar o curso?</br>" +
    ...
    <script type="module">
        ...
        const tex = <?= json_encode(base64_encode($_SESSION['animacao']['textura'])) ?>;
        const glb = <?= json_encode(base64_encode($_SESSION['animacao']['objeto'])) ?>;
