                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    if ($string == "") {
                                                        echo 'Não é coordenador de nenhum curso!';
                                                    } else {
                                                        echo $string;
                                                    } ?>
                                                </td>
                                                <?php
                                                $sql = "SELECT * FROM ucs INNER JOIN uc_docente ON uc_docente.id_uc = ucs.id_uc INNER JOIN docentes ON uc_docente.id_docente = docentes.id_docente WHERE uc_docente.id_docente = $prof[id_docente]";
                                                $stmt = mysqli_prepare($conn, $sql);
                                                if ($stmt) {
                                                    mysqli_stmt_execute($stmt);
                                                    $result = mysqli_stmt_get_result($stmt);
                                                ...
                                                <td><?php
                                                    if ($stringUc == "") {
                                                        echo 'Não é docente de nenhuma unidade curricular!';
                                                    } else {
                                                        echo $string;
                                                    } ?>
                                                </td>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                        ...
                                                        onclick="setDeleteModalText('<?php echo $prof['nome']; ?>','<?php echo $prof['id_docente'] ?>')">Apagar</button>
                                                </td>
                                            </tr>
                                        <?php
                                        }
