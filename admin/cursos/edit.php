...
$textura = $_SESSION['curso']['Textura'];
?>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body" id="notEditing">
                                        ...
                                        <p style="font-size:30px" class="card-text">Animação:
                                            <?php echo $_SESSION["curso"]["Animacao"] ?></p>
                                    </div>
                                    <div class="card-body" id="Editing" hidden>
                                        <form
                                            action='../../database/cursos/edit.php?id=<?php echo $_SESSION['curso']['id_curso']; ?>'
                                            method="POST">
                                            <p style="font-size:15px">Nome:</p>
                                            <input type="text" style="margin:5px;font-size:20px" class="form-control"
                                                name="nome" id="nome" value="<?php echo $_SESSION["curso"]["nome"]; ?>">
                                            ...
                                            <select style="margin:5px;font-size:20px" class="form-control" name="animacao"
                                                ...
                                                if (isset($_SESSION["curso"]["Animacao"])) {
                                                    foreach ($animacoess as $animacaos) {
                                                        if ($animacaos["id_animacao"] == $_SESSION["curso"]["id_animacao"]) {
                                                            echo '
                                                                    <option selected value="' . $animacaos["id_animacao"] . '">' . $animacaos["nome"] . '</option>';
                                                        } else {
                                                            echo '
                                                                    <option value="' . $animacaos["id_animacao"] . '">' . $animacaos["nome"] . '</option>';
                                                        }
                                                    }
                                                }
                                                ?>
