...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php
                    $sql = "SELECT eventos.*,animacoes.nome as 'Animacao' FROM eventos INNER JOIN animacoes ON eventos.id_animacao = animacoes.id_animacao";
                    $stmt = mysqli_prepare($conn, $sql);
                    ...
                    ?>
                    <!-- Page Heading -->
                    <h1 class="h3 fs-1 text-gray-800 fw-bold">Eventos</h1>
                    <?php
                    if (isset($_SESSION["deleted"])) {
                        echo '<p class="fs-3 text-success">Evento ' . $_SESSION["deletedObject"] . ' apagado com sucesso!</p>';
                    }
                    ?>
                    <?php
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h1 class="m-0 font-weight-bold text-primary">Tabela Eventos</h1>
                            <a class="btn btn-primary" href="../../admin/eventos/create.php">Criar Novo Evento</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $evento['dia']; ?>/<?php echo $evento["mes"] ?>/<?php echo date("Y") ?>
                                                </td>
                                                <td><?php echo $evento['Animacao']; ?></td>
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="../../database/eventos/editar_evento.php?id=<?php echo $evento["id_evento"] ?>">Editar</a>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal"
                                                        onclick="setDeleteModalText('<?php echo $evento['nome']; ?>','<?php echo $evento['id_evento'] ?>')">Apagar</button>
                                                </td>
                                            </tr>
                                        <?php
                                        }
    ...
    <script>
        function setDeleteModalText(name, id) {
            document.getElementById("deleteModalBody").innerHTML = "De certeza que quer apagar o evento: \"" + name + "\"";
