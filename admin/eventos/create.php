                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <form id="form" method="POST">
                                        ...
                                        ?>
                                            <select style="margin:5px;font-size:20px" class="form-control" name="ambito"
                                                ...
                                                <select style="margin:5px;font-size:20px" class="form-control" name="ambito"
                                                    id="ambito" required>
                                                    <option value="" selected disabled>Selecione um âmbito</option>
                                                <?php
                                                foreach ($dataAmbito as $ambito) {
                                                    echo '<option value="' . $ambito['id_ambito'] . '">' . $ambito["nome"] . '</option>';
                                                }
                                                        ...
                                                        ?>
                                                            <select style="margin:5px;font-size:20px" class="form-control"
                                                                ...
                                                                if (isset($_SESSION["create_data"])) {
                                                                    echo '<input type="date" style="margin:5px;font-size:20px" class="form-control"value="' . $_SESSION["create_data"] . '" name="data" id="data" required>';
                                                                } else {
                                                                    echo '<input type="date" style="margin:5px;font-size:20px" class="form-control" name="data" id="data" required>';
                                                                }
                                                                ?>
                                ...
                                <button type="button" id="createButton" class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#createModal" onclick="setCreateModalText()">Criar Evento</button>
                            </div>
